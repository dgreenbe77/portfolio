var PageTransitions = (function() {
	...
	var $main = $('[data-pt-main]'),
		$pages = $main.children('[data-pt-page]'),
		$change = $('[data-page]'),
	...
	function changePage(options) {
        ...
        $('.header').removeClass('navbar--none').removeClass('navbar--white').removeClass('nav-down').addClass('nav-up');
        $('.menu-wrap-2--white').removeClass('menu-wrap-2--white');
		var $nextPage = $pages.eq(current).attr('style', 'top: ' + document.documentElement.scrollTop + 'px;').addClass( 'pt-page-current' );
        var animationClasses = animation(animationIndex);
